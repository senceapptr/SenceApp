...
export function ProfilePage({ onBack, onFollowersClick }: ProfilePageProps) {
  ...
  const skills = [
    { id: 0, name: 'Spor', value: 85, color: '#432870' },
    { id: 1, name: 'Teknoloji', value: 92, color: '#B29EFD' },
    { id: 2, name: 'Finans', value: 76, color: '#432870' },
    { id: 3, name: 'Müzik', value: 68, color: '#B29EFD' },
    { id: 4, name: 'Politika', value: 74, color: '#432870' },
    { id: 5, name: 'Magazin', value: 59, color: '#B29EFD' }
  ];
    ...
    <>
      <div className="min-h-screen bg-[#F2F3F5] relative overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 pt-16">
          ...
          <button className="w-10 h-10 rounded-full bg-[#432870] flex items-center justify-center text-white hover:bg-[#5A3A8B] transition-colors">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center px-6 mb-8">
          ...
          <div className="flex justify-center mb-6">
            <button 
              ...
              className="w-32 h-32 rounded-full bg-gradient-to-r from-[#432870] to-[#B29EFD] p-1 hover:scale-105 transition-transform duration-300 group relative"
            >
          ...
          <button
            ...
            className="mb-6 hover:bg-white/50 rounded-2xl p-4 transition-colors group"
          >
            ...
            <p className="text-[#202020]/50 text-sm mt-1">Profili paylaş</p>
          </button>
          ...
          <div className="flex gap-4 justify-center mb-6">
            <button
              ...
              className="bg-[#432870] hover:bg-[#5A3A8B] text-white px-6 py-2 rounded-full font-bold text-sm transition-colors"
            >
              1,247 Takipçi
            </button>
            <button
              onClick={() => onFollowersClick('following')}
              className="bg-[#B29EFD] hover:bg-[#A688F7] text-[#432870] px-6 py-2 rounded-full font-bold text-sm transition-colors"
            >
              342 Takip
            </button>
          </div>
          ...
          {/* Biography Section */}
          <div className="bg-white rounded-2xl p-4 mx-4 mb-6 shadow-sm border border-[#F2F3F5]">
            {isEditingBio ? (
        ...
        <div className="mx-6 mb-8">
          <div className="bg-white rounded-3xl p-6 shadow-lg border border-[#F2F3F5]">
            <div className="text-center mb-6">
              <h3 className="text-[#202020] font-black text-lg mb-2">Tahmin İstatistikleri</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center">
                  <div className="text-[#432870] font-black text-2xl">156</div>
                  <div className="text-[#202020]/70 text-sm">Toplam Tahmin</div>
                </div>
                <div className="text-center">
                  <div className="text-[#B29EFD] font-black text-2xl">89</div>
            ...
            <div className="flex justify-center mb-6">
              <div className="relative w-32 h-32">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-[#202020] font-black text-3xl">{currentSkill.value}%</span>
                </div>
              </div>
            </div>
        ...
        <div className="mx-6 mb-20">
          <div className="bg-white rounded-3xl p-6 shadow-lg border border-[#F2F3F5]">
            <h3 className="text-[#202020] font-black text-lg mb-4">Kredi Değişimi</h3>
            <div className="h-32 flex items-center justify-center border-2 border-dashed border-[#B29EFD]/30 rounded-2xl">
              <div className="text-center">
                <svg className="w-12 h-12 text-[#B29EFD]/50 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
                <p className="text-[#202020]/70 text-sm">Grafik yakında eklenecek</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center p-6">
            <div className="bg-white rounded-3xl p-8 max-w-sm w-full animate-in zoom-in-95">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-[#432870] font-bold">@mehmet_k</p>
        ...
        <div className="fixed inset-0 z-50 bg-black">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6">
            <div className="bg-black/50 backdrop-blur-md rounded-2xl p-4 text-center">
              ...
              <p className="text-white/80 text-sm">@mehmet_k</p>
            </div>
          </div>
        </div>
      )}

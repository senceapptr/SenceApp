...
import { View, Text, StyleSheet, Modal, TouchableOpacity, ScrollView, SafeAreaView, Image } from 'react-native';
...
export function CouponDetailModal({ visible, coupon, onClose, onClaimReward }: CouponDetailModalProps) {

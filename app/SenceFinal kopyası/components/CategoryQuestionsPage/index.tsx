...
export function CategoryQuestionsPage({
  ...
  const sortOptions = [
    { id: 'date' as SortType, label: 'Eklenme Tarihi', icon: '📅' },
    { id: 'votes' as SortType, label: 'Oylanma Sayısı', icon: '👥' },
    { id: 'ending' as SortType, label: 'Bitme Tarihi', icon: '⏰' },
    { id: 'odds' as SortType, label: 'Yüksek Oranlar', icon: '📊' },
  ];
              ...
              {sortOptions.map((option, index) => (
                ...
                >
                  ...
                  <Text style={[
                    ...
                    { color: sortBy === option.id ? '#432870' : theme.textSecondary }
                  ]}>
                    {option.label}
                  </Text>
                  {sortBy === option.id && (

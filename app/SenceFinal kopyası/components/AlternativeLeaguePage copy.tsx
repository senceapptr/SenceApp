...
export function AlternativeLeaguePage({ onMenuToggle }: AlternativeLeaguePageProps) {
  ...
  const [hasVisitedLeagues, setHasVisitedLeagues] = useState(false);
  ...
  // Derive lists for sections similar to Figma web: featured and community
  const featuredLeagues = leagues.filter(l => l.isFeatured);
  const communityLeagues = leagues.filter(l => !l.isFeatured);

  const categories = [
    { id: 'spor', name: 'Spor', icon: '⚽', selected: false },
    { id: 'teknoloji', name: 'Teknoloji', icon: '💻', selected: true },
    { id: 'kripto', name: 'Kripto', icon: '₿', selected: false },
    { id: 'politika', name: 'Politika', icon: '🏛️', selected: false },
    { id: 'ekonomi', name: 'Ekonomi', icon: '📈', selected: false },
    { id: 'eglence', name: 'Eğlence', icon: '🎬', selected: false }
  ];
  ...
  const handleCategoryToggle = (categoryId: string) => {
    // Toggle category selection logic
  };
            ...
            <View style={styles.categoriesContainer}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  ...
                  setSelectedCategory('my-leagues');
                }}
              >

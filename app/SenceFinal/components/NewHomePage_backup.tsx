    ...
    return (
      ...
      >
        ...
        {/* Daily Challenge & Tasks Section */}
          <View style={[styles.section, styles.activitiesSection]}>
          ...
          <View style={styles.buttonsContainer}>
            ...
            <View style={styles.tasksButtonContainer}>
              <TasksButton onTasks={handleTasksOpen} />
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  challengeButtonContainer: {
    flex: 1, // Same size as tasks button
  },
  tasksButtonContainer: {
    flex: 1, // Same size as challenge button
  },
  couponsContainer: {
    paddingLeft: 16,
    paddingRight: 16,

...
export function SearchPage({ onQuestionDetail, onVote, showHeader = true, onAlternativeSearchClick }: SearchPageProps) {
        ...
        <div className="px-5 pt-16 pb-4">
          <div className="flex items-center justify-between mb-4">
            ...
            {onAlternativeSearchClick && (
              <button
                onClick={onAlternativeSearchClick}
                className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-4 py-2 rounded-full text-sm font-bold hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                ✨ Alternatif
              </button>
            )}

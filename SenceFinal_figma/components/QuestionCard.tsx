...
export function QuestionCard({ 
  ...
  if (isCompact) {
    return (
      <div className="bg-white rounded-2xl p-3 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300">
        ...
        {/* Compact Voting Buttons - Standardized Colors */}
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="bg-[#34C759] hover:bg-[#34C759]/90 text-white font-bold text-xs py-2 px-3 rounded-lg transition-all duration-200 transform active:scale-95"
          >
          ...
          <button
            ...
            className="bg-[#FF3B30] hover:bg-[#FF3B30]/90 text-white font-bold text-xs py-2 px-3 rounded-lg transition-all duration-200 transform active:scale-95"
          >
            <div className="text-center">
              <div>HAYIR</div>
  ...
  return (
    <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300">
      ...
      {/* Full Width Voting Buttons - Bottom - Standardized Colors */}
      <div className="flex rounded-lg overflow-hidden border border-gray-200 h-12 shadow-sm">
        <button
          ...
          className="flex-1 bg-[#34C759] hover:bg-[#34C759]/90 text-white font-bold transition-all duration-200 flex items-center justify-center transform active:scale-95"
        >
        ...
        <button
          ...
          className="flex-1 bg-[#FF3B30] hover:bg-[#FF3B30]/90 text-white font-bold transition-all duration-200 flex items-center justify-center transform active:scale-95"
        >
          <div className="flex items-center gap-2">
            <span>HAYIR</span>
